  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <div className="mb-5 flex flex-col md:flex-row md:items-center md:justify-between gap-2">
        <div className="text-sm text-slate-600">กด <kbd class='px-2 py-1 rounded bg-slate-200'>Ctrl/⌘</kbd> + <kbd class='px-2 py-1 rounded bg-slate-200'>K</kbd> เพื่อค้นหาอย่างรวดเร็ว</div>
        <div className="flex items-center gap-2">
