...
<Button onClick={()=>setSearchOpen(true)}>ค้นหาสินค้า (⌘K)</Button>
      ...
      <Tabs defaultValue="builder" className="space-y-4">
        ...
        <TabsContent value="builder" className="space-y-4">
          ...
          <div className="flex items-center justify-between gap-2">
            <div className="text-sm text-slate-600">จัดสเปคคอมพิวเตอร์ • Ubon Computer Spec V.4</div>
            <div className="flex items-center gap-2">
              <Button variant="secondary" onClick={resetSpec}><Trash2 className="w-4 h-4 mr-1.5" />รีเซ็ตสเปค</Button>
            </div>
          </div>
  ...
  <DialogContent className="sm:max-w-[720px]">
    ...
    <div className="space-y-3">
      ...
      />
      <div className="text-xs text-muted-foreground">ผลลัพธ์เรียงตาม: {({default:"ค่าเริ่มต้น", priceAsc:"ราคาต่ำ→สูง", priceDesc:"ราคาสูง→ต่ำ", nameAsc:"ชื่อ A→Z", stockDesc:"สต็อกมาก→น้อย"} as Record<SortMode,string>)[sortMode]}</div>
