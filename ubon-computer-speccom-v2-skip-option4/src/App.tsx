 ...
 * - Add-ons (Monitor, Software) with quantity
 * - Summary with total price, copy & print PDF
...
// ===== Base Picker =====
function BasePicker({ inventory, selection, onSelect, sortMode, onChangeSort }:{ inventory: Product[]; selection: Partial<Record<BaseCategory, Product>>; onSelect:(cat:BaseCategory, product:Product|null)=>void; sortMode: SortMode; onChangeSort:(m:SortMode)=>void; }){
  const byCat = useMemo(()=>{
    ...
    <div className="p-4 md:p-8 max-w-7xl mx-auto">
      ...
      <Tabs defaultValue="builder" className="space-y-4">
        ...
        <TabsContent value="builder" className="space-y-4">
          <BasePicker inventory={inventory} selection={build.base} onSelect={selectBase} sortMode={sortMode} onChangeSort={setSortMode} />
